...
class LunarEnvNoGravity(LunarEnvironment):
    ...
    def _get_reward(self):
        ...
        # based on magnitude
        position_error = - np.linalg.norm(self.delta_position) /  (self.EARTH_MOON_MEAN_DISTANCE - self.destination_object_orbit_radius)
        ...
        reward = position_error + goal_achieved_reward
        # print(positional_reward, mass_reward, velocity_reward)
        reward_components = [position_error, goal_achieved_reward]
