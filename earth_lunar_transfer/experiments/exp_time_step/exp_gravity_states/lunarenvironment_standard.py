...
class LunarEnvForceHelper(LunarEnvironment):
    ...
    def _get_reward(self):
        ...
        reward = positional_reward + velocity_reward + mass_reward \
        ...
        reward_components = [positional_reward, velocity_reward, mass_reward, time_penalty, fuel_penalty,
                             earth_region_penalty, moon_region_penalty, space_penalty]
